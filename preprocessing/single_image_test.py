...
def apply_ms(imgs: Generator[pathlib.PosixPath, None, None], destination: str) -> None:
    ...
    for img in imgs:
        ...
        bandwidth = estimate_bandwidth(flat_image, quantile=0.06, n_samples=100)
...
if __name__ == "__main__":
    img_dir = ["/home/szymonbogus/Documents/myProjects/STUDIA/inzynierka/temp_imgs/ProcessedImages/MultiRoiProcess"
               "/OriginalCropped"]
    dest_dir = "/home/szymonbogus/Documents/myProjects/STUDIA/inzynierka/temp_imgs/ProcessedImages/SingleProcess"
